        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    clientBirthdayCheck: defineResource(apiVer + "/clients/", {}, {
                    	post:{method: 'POST', params:{}}
                    }),
                    clientIdenfierTemplateResource: defineResource(apiVer + "/clients/:clientId/identifiers/template", {clientId: '@clientId'}, {
                        get: {method: 'GET', params: {}}
                    }),
                    clientAddressTemplateResource: defineResource(apiVer + "/clients/:clientId/addresses/template", {clientId: '@clientId'},{
                        get: {method: 'GET', params: {}}
                    }),
                    ...
                    dsaResource: defineResource(apiVer + "/dsa/:dsaId", {dsaId: '@dsaId', status:"all"},{
                      getAllDsas:{method: 'GET', params:{}, isArray: true},
                      update: {method: 'PUT'}
                    }),
                    ...
                    paymentToWhomResources: defineResource(apiVer + "/paymenttowhom/:paymentToWhomId", {paymentToWhomId: "@paymentToWhomId"},{
                      getAll : {method: 'GET', params: {}, isArray:true},
                      get: {method:'GET', params:{paymentToWhomId: '@paymentToWhomId'}},
                      update: {method: 'PUT', params:{paymentToWhomId: '@paymentToWhomId'}}
                    }),
