(function (mifosX) {
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/dsas',{
              templateUrl: 'views/organization/dsas.html'
            })
            ...
            .when('/viewdsa/:id', {
              templateUrl: 'views/organization/viewdsa.html'
            })
            .when('/editdsa/:id',{
              templateUrl: 'views/organization/editdsa.html'
            })
            .when('/createdsa/',{
              templateUrl:'views/organization/createdsa.html'
            })
            .when('/managefunds/', {
            ...
            .when('/viewpaymenttowhom/',{
              templateUrl: 'views/organization/viewpaymenttowhom.html'
            })
            .when('/createpaymenttowhom/',{
              templateUrl: 'views/organization/createpaymenttowhom.html'
            })
            .when('/editpaymenttowhom/:id',{
              templateUrl: 'views/organization/editpaymenttowhom.html'
            })
